...
namespace parser{
    ...
    template <>
    void ASTLiteralNode<char>::accept(visitor::Visitor *visit){
        visit->visit(this);
    }

    template <>
    void ASTLiteralNode<std::vector<typename std::iterator_traits<VAR_TYPE>>>::accept(visitor::Visitor *visit){
        visit->visit(this);
    }
