...
namespace parser{
    ...
    enum VAR_TYPE 
    {FLOAT, INT, BOOL, STRING, CHAR, AUTO};
    ...
    class ASTLiteralNode : public ASTExprNode{
        ...
        public:
            ...
            //Overloaded Constructor for Auto
            ASTLiteralNode((std::vector<typename std::iterator_traits<VAR_TYPE>>, unsigned int number) : vartype(VAR_TYPE), number(number)) {};
            T vartype;
            unsigned int number;
